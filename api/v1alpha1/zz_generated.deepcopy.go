...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MaasInstanceRule) DeepCopyInto(out *MaasInstanceRule) {
	*out = *in
	if in.OSImages != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MaasInstanceRule.
func (in *MaasInstanceRule) DeepCopy() *MaasInstanceRule {
	if in == nil {
		return nil
	}
	out := new(MaasInstanceRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MaasValidatorSpec) DeepCopyInto(out *MaasValidatorSpec) {
	*out = *in
	if in.MaasInstanceRules != nil {
		in, out := &in.MaasInstanceRules, &out.MaasInstanceRules
		*out = make([]MaasInstanceRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
